...
public class WorkTimeTrackerApplication extends Application {
	...
	private org.zephyrsoft.trackworktime.Basics basics;
	...
	public void onCreate() {
		...
		basics = new org.zephyrsoft.trackworktime.Basics(this);

		basics.setNotificationChannel(notificationChannel);
		basics.setServiceNotificationChannel(serviceNotificationChannel);

		try {
			PeriodicWorkRequest automaticBackup = new PeriodicWorkRequest.Builder(org.zephyrsoft.trackworktime.AutomaticBackup.class, 24, TimeUnit.HOURS, 6, TimeUnit.HOURS)
					.build();
	...
	public org.zephyrsoft.trackworktime.Basics getBasics() {
		return basics;
	}
