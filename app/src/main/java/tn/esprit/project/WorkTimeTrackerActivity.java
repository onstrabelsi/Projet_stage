...
public class WorkTimeTrackerActivity extends AppCompatActivity
	...
	private void checkAllOptions() {
		...
		if (disabledSections > 0) {
			...
			Intent messageIntent = org.zephyrsoft.trackworktime.Basics.get(this)
				.createMessageIntent(
					disabledSections == 1
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		clockInButton.setOnLongClickListener(v -> {
            Intent i = new Intent(getApplicationContext(), org.zephyrsoft.trackworktime.TimeAheadActivity.class);
            String typeString;
	...
	public void setTarget(DayOfWeek day) {
		if (day == null) {
			...
			Intent i = new Intent(this, org.zephyrsoft.trackworktime.TargetEditActivity.class);
			startActivity(i);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		if (org.zephyrsoft.trackworktime.Basics.get(this).isDevelopmentVersion()) {
	...
	private void selectDataDirectory() {
		if (org.zephyrsoft.trackworktime.DocumentTreeStorage.hasValidDirectoryGrant(this)) {
			org.zephyrsoft.trackworktime.DocumentTreeStorage.requestDirectoryGrant(this,
				...
				org.zephyrsoft.trackworktime.DocumentTreeStorage.getDirectoryName(this));
		} else {
			org.zephyrsoft.trackworktime.DocumentTreeStorage.requestDirectoryGrant(this,
	...
	private void showEventList() {
		...
		Week currentWeek = getCurrentWeek();
		if (currentWeek != null) {
			Intent i = new Intent(this, org.zephyrsoft.trackworktime.EventListActivity.class);
	...
	private void showTaskList() {
		...
		Intent i = new Intent(this, org.zephyrsoft.trackworktime.TaskListActivity.class);
		startActivity(i);
	}

	private void showInsertDefaultTimes() {
		Logger.debug("showing InsertDefaultTimes");
		Intent i = new Intent(this, org.zephyrsoft.trackworktime.InsertDefaultTimesActivity.class);
		startActivity(i);
	}

	private void showOptions() {
		Logger.debug("showing Options");
		Intent i = new Intent(this, org.zephyrsoft.trackworktime.OptionsActivity.class);
		startActivity(i);
	}

	private void showRequestToIgnoreBatteryOptimizations() {
		if (org.zephyrsoft.trackworktime.Basics.get(this).hasToRemoveAppFromBatteryOptimization()) {
			...
			alert.setPositiveButton(getString(R.string.request_to_ignore_battery_optimizations_positive),
				(dialog, whichButton) -> org.zephyrsoft.trackworktime.Basics.get(this).removeAppFromBatteryOptimization());
	...
	private void doUseCurrentLocationAsWorkplace() {
		...
		alert.setPositiveButton(getString(R.string.ok), (dialog, whichButton) ->
			org.zephyrsoft.trackworktime.Basics.get(this).useCurrentLocationAsWorkplace(WorkTimeTrackerActivity.this));
		alert.setNegativeButton(getString(R.string.cancel), (dialog, whichButton) -> {
			// do nothing
		});
		alert.show();
	...
	private void showReports() {
		...
		Intent i = new Intent(this, org.zephyrsoft.trackworktime.ReportsActivity.class);
		startActivity(i);
	}

	private void showAbout() {
		Logger.debug("showing About");
		Intent i = new Intent(this, org.zephyrsoft.trackworktime.AboutActivity.class);
		startActivity(i);
	}
	...
	private void doExportLogs() {
		try {
			File logfile = org.zephyrsoft.trackworktime.Basics.get(this).getCurrentLogFile();
			org.zephyrsoft.trackworktime.DocumentTreeStorage.writing(this, org.zephyrsoft.trackworktime.DocumentTreeStorage.Type.LOGFILE,
	...
	private void doSendLogs() {
		Logger.info("app version: {}", org.zephyrsoft.trackworktime.Basics.get(this).getVersionName());
		Intent emailIntent = new Intent(Intent.ACTION_SEND);
		emailIntent.putExtra(Intent.EXTRA_SUBJECT, getString(R.string.sendLogsSubject));
		Uri fileUri = FileProvider.getUriForFile(this,
			BuildConfig.APPLICATION_ID + ".util.GenericFileProvider", org.zephyrsoft.trackworktime.Basics.get(this).getCurrentLogFile());
	...
	private void showDebug() {
		...
		Intent i = new Intent(this, org.zephyrsoft.trackworktime.DebugActivity.class);
		startActivity(i);
	}
	...
	protected void onResume() {
		...
		if (org.zephyrsoft.trackworktime.DocumentTreeStorage.shouldRequestDirectoryGrant(this)) {
			org.zephyrsoft.trackworktime.DocumentTreeStorage.requestDirectoryGrant(this,
				Constants.PERMISSION_REQUEST_CODE_DOCUMENT_TREE_ON_STARTUP,
				R.string.documentTreePermissionsRequestTextOnStart);
		}
		...
		org.zephyrsoft.trackworktime.Basics.get(this).safeCheckExternalControls();
		...
		switch (requestCode) {
			...
			case Constants.MISSING_PRIVILEGE_ACCESS_LOCATION_FOR_CURRENT_LOCATION_ID:
				...
				if (missingPermissions.isEmpty()) {
					...
					Intent messageIntent = org.zephyrsoft.trackworktime.Basics.get(this).createMessageIntent(
	...
	private void locationPermissionNotGranted(List<String> ungranted) {
		org.zephyrsoft.trackworktime.Basics.get(this).disableLocationBasedTracking();
		org.zephyrsoft.trackworktime.Basics.get(this).disableWifiBasedTracking();
		Intent messageIntent = org.zephyrsoft.trackworktime.Basics.get(this).createMessageIntent(
