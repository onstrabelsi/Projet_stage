...
public class EventListActivity extends AppCompatActivity {
	...
	protected void onResume() {
		locale = org.zephyrsoft.trackworktime.Basics.get(this).getLocale();
		super.onResume();
	}
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		timerManager = org.zephyrsoft.trackworktime.Basics.get(this).getTimerManager();
			...
			if (menuItem.getItemId() == R.id.menu_item_delete) {
				...
				alert.setPositiveButton(getString(R.string.ok),
						(dialog, whichButton) -> {
							...
							org.zephyrsoft.trackworktime.Basics.get(EventListActivity.this).safeCheckExternalControls();
						});
	...
	private class EventAdapter extends RecyclerView.Adapter<ViewHolder> {
		...
		class EventSeparatorHolder extends ViewHolder {
	...
	private final class EventKeyProvider extends ItemKeyProvider<Long> {
		...
		public int getPosition(@NonNull Long key) {
			ViewHolder viewHolder = mRecyclerView.findViewHolderForItemId(key);
