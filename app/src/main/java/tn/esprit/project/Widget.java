...
public class Widget extends AppWidgetProvider {
    ...
    private void init(Context context, AppWidgetManager manager, int[] widgetIds) {
        ...
        org.zephyrsoft.trackworktime.Basics basics = org.zephyrsoft.trackworktime.Basics.get(context);
    ...
    private void updateWorkTime() {
        ...
        Intent intent = new Intent(context, org.zephyrsoft.trackworktime.WorkTimeTrackerActivity.class);
    ...
    private void updateClockInBtn() {
        ...
        PendingIntent intent = createIntentForAction(org.zephyrsoft.trackworktime.Constants.CLOCK_IN_ACTION);
        views.setOnClickPendingIntent(viewId, intent);
    }

    private void updateClockOutBtn() {
        PendingIntent intent = createIntentForAction(org.zephyrsoft.trackworktime.Constants.CLOCK_OUT_ACTION);
    ...
    private PendingIntent createIntentForAction(String action) {
        Intent intent = new Intent(context, org.zephyrsoft.trackworktime.ThirdPartyReceiver.class);
